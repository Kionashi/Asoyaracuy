        ...
        <div class="nav-tabs-custom margin">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    {!! Form::model($staticContent, array('files' => true, 'id' => 'editStaticContentForm', 'class' => 'panel-body form-horizontal')) !!}
                    <div class="box-body">
                        <div class="form-group">
                            {!! Form::label('section', 'Sección', array('class' => 'col-lg-2 col-sm-2 control-label')) !!}
                            <div class="col-lg-8">
                                <div>
                                    {!! Form::select('section', $sections, $staticContent->section, array('class' => 'form-control select2', 'placeholder' => 'Seleccione una opción', 'style' => 'width:100% !important;')) !!}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                {!! Form::textArea('content', $staticContent->content, array('id' => 'content', 'class' => 'control-ckeditor form-control')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <div class="checkbox">
                                    {!! Form::checkbox('enabled', null, $staticContent->enabled, array('class' => 'minimal-red')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
