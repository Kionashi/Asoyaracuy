                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="checkbox">
                                        {!! Form::checkbox('enabled', null, $poll->enabled ,array('class' => 'minimal-red')) !!}
                                    </div>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                {!! Form::label('options', 'Opciones', array('class' => 'col-lg-2 col-sm-2 control-label')) !!}
                                <div class="col-lg-8">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody id="tbody" class="pollOptionsContent" >
                                            ...
                                            <tr id="tr-{{$i+1}}"  data-parameter="{{$i+1}}">
                                                ...
                                                <td class="form-group">
                                                    <input type="text" name="options[{{$i+1}}][title]" value="{{$pollOption->title}}" class="form-control optionInputs" <?=$allowEditQuestion?'':'disabled'?> />
                                                </td>
                                                <td class="form-group text-center">
                                                    <input type="text" name="options[{{$i+1}}][color]" value="{{$pollOption->color}}" class="form-control form-control-options colorpicker" <?=$allowEditQuestion?'':'disabled'?> />
                                                </td>
                                                @if($allowEditQuestion)
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a class="btn btn-sm btn-danger deleteOption"  data-id="{{$i+1}}"  data-parameter="{{$i+1}}"  title="Eliminar" >
                                    ...
                                    <div id="error-default-option" class="help-block help-block-error right-light">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var counter = <?=$totalPollOptions?>; 
        var index = <?=$totalPollOptions?>;
        ...
        $(container).on('click', '.deleteOption', function(e){ 
            if(counter>=2){
                ...
                alert('The product parameters must have at least one option');
            }
        });
